...
#include "../../../../wx-client/ui/LoginWidget.h"
...
void LoginWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (LoginWidget::*)(int , const QString & )>(_a, &LoginWidget::loggedIn, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (LoginWidget::*)()>(_a, &LoginWidget::goRegister, 1))
            return;
    }
}
...
// SIGNAL 0
void LoginWidget::loggedIn(int _t1, const QString & _t2)
{
