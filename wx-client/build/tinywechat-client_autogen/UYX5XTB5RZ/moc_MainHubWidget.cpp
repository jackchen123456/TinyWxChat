...
Q_CONSTINIT static const qt_meta_stringdata_MainHubWidget_t qt_meta_stringdata_MainHubWidget = {
    {
        ...
        QT_MOC_LITERAL(98, 15),  // "onFriendsLoaded"
        QT_MOC_LITERAL(114, 29),  // "QList<std::pair<int,QString>>"
        QT_MOC_LITERAL(144, 7)   // "friends"
    },
    "MainHubWidget",
    "openChat",
    "",
...
void MainHubWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->onFriendsLoaded((*reinterpret_cast< std::add_pointer_t<QList<std::pair<int,QString>>>>(_a[1]))); break;
        default: ;
        }
